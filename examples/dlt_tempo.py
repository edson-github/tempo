...
def ts_bronze():
    return (
        ...
        .option("header", "true")
        .load("dbfs:/home/tempo/Phones_accelerometer")
        .withColumn(
            "event_ts",
            (col("Arrival_Time").cast("double") / 1000).cast("timestamp"),
        )
...
def ts_ft():
    ...
    return phone_accel_tsdf.fourier_transform(timestep=1, valueCol="x").df
